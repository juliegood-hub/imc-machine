...
const PAGE_FLOW = [
  ...
  },
  {
    ...
    features: 'Includes event basics, venue/ticketing, crew, production details, and reusable templates.',
  ...
  },
  {
    ...
    features: 'Includes guided mode, section focus filters, role ownership, and ordered execution steps.',
    nextPath: '/events/create',
    nextTitle: 'Start Event',
