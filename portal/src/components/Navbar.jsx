  ...
  return (
    <nav className="bg-[#0d1b2a] text-white px-4 md:px-6 py-3 flex items-center justify-between sticky top-0 z-50">
      <Link to="/" className="flex items-center gap-3 no-underline">
        ...
        <div>
          <div className="text-sm font-semibold text-[#c8a45e] leading-tight">Good Creative Media</div>
          <div className="text-xs text-gray-400 leading-tight">Integrated Marketing Communications</div>
        </div>
      </Link>
