  ...
  return (
    <nav className="bg-[#0d1b2a] text-white px-4 md:px-6 py-3 flex items-center justify-between sticky top-0 z-50">
      <Link to={brandHref} className="flex items-center gap-3 no-underline">
        ...
        <div>
          <div className="text-[11px] font-semibold text-[#c8a45e] uppercase tracking-[0.08em] leading-tight">Good Creative Media</div>
          <div className="text-sm font-semibold text-white leading-tight">The IMC Machine</div>
